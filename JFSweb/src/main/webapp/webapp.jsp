...
<tr>
  ...
  <td><input type="text" name="amount" value="2336" placeholder="Enter the Amount"></td>
   </tr>
    </tr>
   <td>Product Price</td>
  <td><input type="text" name="totStack_avail" value="50" placeholder="Enter the StockAvailable"></td>
   </tr>
